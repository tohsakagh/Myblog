    ...
    <div class="animate__animated animate__fadeInUp footer-wrap">
        ...
        <el-row :gutter="20" class=" footer-info">
            <el-col class="ewm" :xs="24" :sm="4" >
                <el-image src="https://myblog-1313287673.cos.ap-chongqing.myqcloud.com/myblog/foot.jpg" alt="图片加载失败"
            ...
            <el-col class="connect" :xs="24" :sm="5">
                ...
                <div class="ui inverted link list">
                    <p class="item">Email：22277299512@qq.com</p>
                    <p class="item">QQ：22277299512</p>
                </div>
            </el-col>
        ...
        <el-row>
            <div class="author">
                <p class="m-text-thin m-text-spaced m-opacity-mini">不拘一格的风格</p>
            </div>
        </el-row>
    </div>
</template>
...
export default {
    ...
    methods: {
        async getfooterList() {
            const {data: res} = await this.$blog.get('/front/blog/getFooterBlogList')
